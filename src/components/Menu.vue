...
<nav class="flex items-center justify-between flex-wrap bg-teal-500 p-6">
    ...
    <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
      <div class="text-sm lg:flex-grow">
        ...
        <span @click="mover('empresas')" class="hover:cursor-pointer block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">
          Empresas
        </span>
        <span @click="mover('datastage')" class="hover:cursor-pointer block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">
          Datastage
        </span>
      </div>
      <div>
